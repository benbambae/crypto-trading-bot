    ...
    try:
        ...
        if coin:
            ...
            for metric in all_metrics:
                ...
                message.append(f"{profit_emoji} *{metric['coin']}*: Win Rate {metric['win_rate']:.1f}%, Profit ${metric['profit']:.2f} \\({metric['trades']} trades\\)")
            
            message.append(f"\n💰 *Total Portfolio Capital: ${total_capital:.2f}*")
...
def generate_daily_summary():
    ...
    try:
        ...
        for coin in SUPPORTED_COINS:
            ...
            summary.append(f"PnL: ${today_pnl:.2f}\n")
